...
# 模型选择配置
USE_LOCAL_MODEL = False  # 设置为True使用本地模型，False使用API
LOCAL_MODEL_PATH = "Qwen/Qwen2.5-VL-7B-Instruct"  # 本地模型路径
MAX_NEW_TOKENS = 1024  # 生成的最大token数

# API配置
API_KEY = os.getenv('DASHSCOPE_API_KEY')  # 在实际应用中应使用环境变量
...
HTML_AI_ANALYSIS = '<div class="section-title">🤖 AI分析报告</div>'